    ...
    <tbody>
        ...
        <tr>
            <td style="font-family:'Arial',Helvetica,sans-serif;font-size:12px;color:#5f6062;">
                ...
                <p>A través de este email proporcionamos sus credenciales de acceso a nuestra plataforma.</p>
                <p><strong>Usuario:</strong> {{ $information['username'] }}<br>
                <strong>Contraseña:</strong> {{ $information['password'] }}</p>
